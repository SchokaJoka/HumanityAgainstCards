                                ...
                                <div class="flex flex-col gap-4">
                                    <div v-for="blackCard, index in blackCards" :key="index"
                                        ...
                                        <div v-else class="w-full flex flex-col gap-2">
                                            <div v-for="part, index in currentBlackCardText" :key="index"
                                            ...
                                            <div class="w-full flex flex-row gap-2">
                                                <Button
                                                    v-if="!currentBlackCardText[currentBlackCardText.length - 1].isGap"
                                                    @click="insertGap()" variant="primary" size="sm" block
                                                    class="rounded-xl">Insert Gap</Button>
                                                <Button
                                                    v-if="currentBlackCardText[currentBlackCardText.length - 1].isGap"
                                                    @click="insertText()" variant="primary" size="sm" block
                                                    class="rounded-xl">Insert Text</Button>
                                                <Button v-if="currentBlackCardText.length > 1" @click="deleteLast()"
                                                    variant="primary" size="sm" block class="rounded-xl">Delete</Button>
                                            </div>
                                        </div>
